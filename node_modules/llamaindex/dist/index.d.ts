 ...
 */
declare function getNodesFromDocument(doc: BaseNode, textSplitter: SentenceSplitter, includeMetadata?: boolean, includePrevNextRel?: boolean): ImageDocument<any>[] | TextNode<Metadata>[];
/**
...
declare class VectorIndexRetriever implements BaseRetriever {
    ...
    protected buildVectorStoreQuery(embedModel: BaseEmbedding, query: string): Promise<VectorStoreQuery>;
